...
+ (void)uploadFileWithChatMessage:(ChatMessage * _Nonnull)chatMessage sendMessageListener:(void (^ _Nonnull)(BOOL, NSError * _Nullable, ChatMessage * _Nullable))sendMessageListener;
@end
...
@interface FlyMessenger (SWIFT_EXTENSION(FlyCore))
+ (void)forwardMessageMediaAccessWithMessages:(ChatMessage * _Nonnull)messages jid:(NSString * _Nonnull)jid currentMessageIndex:(NSInteger)currentMessageIndex messageIds:(NSArray<NSString *> * _Nonnull)messageIds;
...
+ (void)forwardMessageWithMessage:(ChatMessage * _Nonnull)message jid:(NSString * _Nonnull)jid currentMessageIndex:(NSInteger)currentMessageIndex messageIds:(NSArray<NSString *> * _Nonnull)messageIds;
@end
